(function () {
	...
	/* @ngInject */
	function MainController($state, $mdSidenav, MainService, $scope) {
...
// Reduce the animation steps for demo clarity.
				...
				window.myPieChart = new Chart(ctx).Line(startingData, {animationSteps: 15});

				setInterval(function(){
					// Add two random numbers for each dataset
					window.myPieChart.addData([Math.random() * 100, Math.random() * 100], ++latestLabel);
